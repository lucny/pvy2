...
$(function () {
    ...
    var TBlock = function () {
        ...
        _createClass(TBlock, [{
            ...
            value: function showResult(dataBlocks) {
                ...
                $(this.obj).find(".dashboard").find(".mark-panel").append("<p class=\"label\"><span class=\"glyphicon glyphicon-scale\"></span> Mark</p><h3>1</h3>");
            }
        }, {
            key: "toString",
    ...
    var TInput = function (_TNode) {
        ...
        function TInput(obj) {
            ...
            _this.points = $(obj).data('points') ? $(obj).data('points') : 2;
            return _this;
        }
